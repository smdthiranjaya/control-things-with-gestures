...
def get_camera_sources():
    ...
    esp32_url = settings.get("esp32_cam_url", "http://192.168.1.25:81/stream")
...
def open_camera(source, current_source):
    ...
    try:
        ...
        if current_source == "ESP32-CAM":
            ...
            print(f"Opening computer camera at index {source}")
        ...
        if cap is not None and cap.isOpened():
            ...
            print(f"Failed to open camera {current_source}")
            return False
